...
public class Config {
	...
	public static void syncConfig() {
		...
		if (title != null && title.trim().length() > 0) Display.setTitle(title);
		//-----------------------------------------------------------------------
		if (!isInit) cursor();
		//-----------------------------------------------------------------------
		...
		if (!icon16x16.equals("icons/icon_16x16.png") && !icon32x32.equals("icons/icon_32x32.png")) {
		...
		System.out.println("-----hgstjrgkjrgkjrgkjrgkjrgkjrgkjrgkjrgkjrgkjrgkjrgkryf------");
		//-----------------------------------------------------------------------
		optionsBackground = config.get(categoryGui, "optionsBackground", /*SetTitleMod.MODID + ":icons/icon_16x16.png"*/"").getString();
		if (!isInit) optionsBackground();
		//-----------------------------------------------------------------------
